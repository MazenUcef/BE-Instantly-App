...
export const SESSION_PROGRESS_TRANSITIONS: Record<
  SessionStatus,
  SessionStatus[]
> = {
  [SESSION_STATUS.STARTED]: [SESSION_STATUS.ON_THE_WAY, SESSION_STATUS.CANCELLED],
  [SESSION_STATUS.ON_THE_WAY]: [SESSION_STATUS.ARRIVED, SESSION_STATUS.CANCELLED],
  [SESSION_STATUS.ARRIVED]: [SESSION_STATUS.WORK_STARTED, SESSION_STATUS.CANCELLED],
  [SESSION_STATUS.WORK_STARTED]: [SESSION_STATUS.COMPLETED, SESSION_STATUS.CANCELLED],
  [SESSION_STATUS.COMPLETED]: [],
  [SESSION_STATUS.CANCELLED]: [],
};
