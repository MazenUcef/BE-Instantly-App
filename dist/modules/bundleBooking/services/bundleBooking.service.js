...
const bundleBooking_state_1 = require("../helpers/bundleBooking-state");
...
class BundleBookingService {
    ...
    static async cancelBundleBooking(input) {
        ...
        (0, bundleBooking_state_1.assertValidBookingTransition)(booking.status, bundleBooking_constants_1.BUNDLE_BOOKING_STATUS.CANCELLED);
        if (!(0, bundleBooking_state_1.canCancelBooking)(booking.status)) {
            throw new errorHandler_1.AppError("Booking cannot be cancelled now", 400);
        }
        const cancelledBy = isCustomer
            ? bundleBooking_constants_1.BUNDLE_BOOKING_CANCELLED_BY.CUSTOMER
            : bundleBooking_constants_1.BUNDLE_BOOKING_CANCELLED_BY.SUPPLIER;
        const updatedBooking = await bundleBooking_repository_1.BundleBookingRepository.updateBooking(String(booking._id), {
