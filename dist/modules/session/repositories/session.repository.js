...
class SessionRepository {
    ...
    static findByOfferId(offerId, session) {
        return session_model_1.default.findOne({ offerId }).session(session || null);
    }
    ...
    static updateStatus(sessionId, currentStatus, nextStatus, extraSet = {}, session) {
    ...
    static markCancelled(sessionId, currentStatus, cancelledBy, cancellationReason, session) {
        return session_model_1.default.findOneAndUpdate({
            _id: sessionId,
            status: currentStatus,
        }, {
