...
class SessionEventService {
     ...
     */
    static emitSessionCancelled(session, meta) {
        const io = (0, socket_1.getIO)();
        const payload = {
        ...
        io.to(socket_1.socketRooms.chat(session._id.toString())).emit(socket_1.socketEvents.SESSION_CANCELLED, payload);
        io.to(socket_1.socketRooms.user(session.customerId.toString())).emit(socket_1.socketEvents.SESSION_CANCELLED, payload);
        io.to(socket_1.socketRooms.user(session.supplierId.toString())).emit(socket_1.socketEvents.SESSION_CANCELLED, payload);
    }
